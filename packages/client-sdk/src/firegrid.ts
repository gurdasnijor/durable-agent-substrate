...
// host-side unified channel-bindings module (in the runtime package) is
// the canonical source of the channel Tags. Standalone client composition
// must compose those bindings explicitly (or run against a real host).

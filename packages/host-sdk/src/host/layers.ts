...
export const FiregridRuntimeHostLive = (
  ...
  return Layer.mergeAll(
    ...
    // address into this same instance. `FiregridRuntimeContextMcpBaseUrlLive`
    // has no RCWS dependency, so it composes orthogonally to the
    // self-discharge wiring and stays last (provided to the full set).

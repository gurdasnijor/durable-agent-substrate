...
// wait/child-output streams deletion: `RuntimeObservationStreams` no longer
// appears in the executor's R channel — the WaitForWorkflow Activity resolves
// its sources through `RuntimeChannelRouter`, which is already captured here
// for `send`/`call` dispatch.
